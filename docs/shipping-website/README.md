...
| [11-full-private-e2e-smoke.md](11-full-private-e2e-smoke.md) | Operator runbook and evidence log for the full closed-staging launch rehearsal before live cutover. |

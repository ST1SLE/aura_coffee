...
<!-- Source: PDD §5.2, §6.1, §7.1 Phase 6 item 3, INV-010.
     GREEN re-applies the exact ADDED delta from shop-settings-admin-api-red.
     No requirement text diverges from RED; this file exists so the GREEN
     change has a mirror spec that can be re-archived after implementation. -->

...
//   SCOPE:   BrandMark component for staff app chrome and auth panels, plus
//            BrandWordmark for sidebar and mobile headers.
//   DEPENDS: web/admin/public/brand/aura-heart-{olive,white}.png,
//            web/admin/public/brand/aura-wordmark-{olive,white}.png.
//   LINKS:   docs/development-plan.xml M-WEB-ADMIN; PDD 4.4.
//   ROLE:    RUNTIME
//   MAP_MODE: EXPORTS
// END_MODULE_CONTRACT
//
...
//   LINKS:   Layout.tsx, LoginPage.tsx, CourierShell.tsx.
...
//            mode for staff app chrome and auth panels.
//   INPUTS:  className?: string - caller-owned sizing/styling classes;
//            alt?: string - accessible label when not decorative;
//            decorative?: boolean - hide the image from assistive tech;
//            tone?: "olive" | "white" - source variant for light/dark surfaces.

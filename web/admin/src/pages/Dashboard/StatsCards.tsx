...
export function StatsCards({
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2">
      <div className="admin-surface p-5" data-testid="stats-card-revenue">
        <p className="text-sm text-muted-foreground">
          {t('pages.dashboard.cards.revenue')}
        </p>
        <p className="admin-numeric mt-2 text-3xl font-semibold">{revenue}</p>
      </div>
      <div className="admin-surface p-5" data-testid="stats-card-orders">
        <p className="text-sm text-muted-foreground">
          {t('pages.dashboard.cards.orders')}
        </p>
        <p className="admin-numeric mt-2 text-3xl font-semibold">{count}</p>
      </div>
    </div>
  );
}
